#UDP Sockets
#Tek taraflı handshake yok


"""
UDP (User Datagram Protocol) is a communications protocol
that is primarily used for establishing low-latency and loss-tolerating
...
import logging
import multiprocessing #prosesin biri dinleyip biri yayın yapacak
import threading
import socket
import sys
import time
